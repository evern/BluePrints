...
namespace BluePrints.ViewModels
{
        ...
        <DOCTYPE, DOCTYPE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedValueValidation(DOCTYPE projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }

        public override string UnifiedRowValidation(DOCTYPE projection)
        {
            return string.Empty;
        }
        #endregion
