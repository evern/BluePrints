...
namespace BluePrints.ViewModels
{
        ...
        <DISCIPLINE, DISCIPLINE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedValueValidation(DISCIPLINE projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
        ...
        {
            get { return "DISCIPLINECollectionViewModelWrapper_v2"; }
        }
