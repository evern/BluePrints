...
{
    public class DISCIPLINECollectionViewModelWrapper : CollectionViewModelsWrapper<DISCIPLINE, DISCIPLINE, Guid, IBluePrintsEntitiesUnitOfWork, CollectionViewModel<DISCIPLINE, DISCIPLINE, Guid, IBluePrintsEntitiesUnitOfWork>>
    {
        /// <summary>
        /// Creates a new instance of DISCIPLINECollectionViewModelWrapper as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static DISCIPLINECollectionViewModelWrapper Create(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected DISCIPLINECollectionViewModelWrapper(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        }
        ...
        {
            CreateMainViewModel(this.bluePrintsUnitOfWorkFactory, x => x.DISCIPLINES);
        ...
        protected override string ViewName
        {
            get
            {
                return "DISCIPLINECollectionViewModelWrapper";
            }
        }
        #endregion
    }
