...
{
    public class USER_PROGRESS_ITEMCollectionViewModelWrapper : PROGRESS_ITEMSCollectionViewModelWrapper
    {
        ...
        protected override void InitializeSummarizer()
        {
            ...
            {
                PROGRESS livePROGRESS = deliverableGroupByProject.Deliverables.First().loadPROGRESS;
