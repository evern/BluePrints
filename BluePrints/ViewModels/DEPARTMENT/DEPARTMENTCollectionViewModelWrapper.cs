...
{
    public class DEPARTMENTCollectionViewModelWrapper : CollectionViewModelsWrapper<DEPARTMENT, DEPARTMENT, Guid, IBluePrintsEntitiesUnitOfWork, CollectionViewModel<DEPARTMENT, DEPARTMENT, Guid, IBluePrintsEntitiesUnitOfWork>>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected DEPARTMENTCollectionViewModelWrapper(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        }
        ...
        {
            CreateMainViewModel(this.bluePrintsUnitOfWorkFactory, x => x.DEPARTMENTS);
        ...
        protected override string ViewName
        {
            get
            {
                return "DEPARTMENTCollectionViewModelWrapper";
            }
        }
        #endregion
    }
