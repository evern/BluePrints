...
namespace BluePrints.ViewModels
{
        ...
        <REGISTER_ISSUE, REGISTER_ISSUE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        /// </summary>
        public bool OnBeforeEntitySaved(REGISTER_ISSUE entity)
        {
        ...
        {
            get { return "REGISTER_ISSUECollectionViewModelWrapper" + loadPROJECT == null ? Guid.Empty.ToString() : loadPROJECT.GUID.ToString(); }
        }
