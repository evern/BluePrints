...
namespace BluePrints.ViewModels
{
        ...
        <REGISTER_LL, REGISTER_LL, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        protected override bool onBeforeEntitySavedIsContinue(REGISTER_LL projection)
        {
        ...
        public override string UnifiedValueValidation(REGISTER_LL projection, string field_name, object new_value)
        {
