...
namespace BluePrints.ViewModels
{
        ...
        <REGISTER_LL, REGISTER_LL, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        /// </summary>
        public bool OnBeforeEntitySaved(REGISTER_LL entity)
        {
        ...
        {
            get { return "REGISTER_LLCollectionViewModelWrapper" + loadPROJECT == null ? Guid.Empty.ToString() : loadPROJECT.GUID.ToString(); }
        }
