...
namespace BluePrints.ViewModels
{
        ...
        <REGISTER_NC, REGISTER_NC, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        protected override OperationInterceptMode OnBeforeProjectionSaveIsContinue(REGISTER_NC projection, out bool isNew)
        {
        ...
        public override string ViewName
        {
            ...
            get { return "REGISTER_NCCollectionViewModelWrapper_v2"; }
        }
