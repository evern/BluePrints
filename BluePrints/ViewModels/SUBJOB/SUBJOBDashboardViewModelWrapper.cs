...
namespace BluePrints.ViewModels
{
        ...
        DashboardViewModelWrapper<SUBJOB, SUBJOB_Dashboard, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedRowValidation(SUBJOB_Dashboard projection)
        {
            return string.Empty;
        }

        public override string UnifiedValueValidation(SUBJOB_Dashboard projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
