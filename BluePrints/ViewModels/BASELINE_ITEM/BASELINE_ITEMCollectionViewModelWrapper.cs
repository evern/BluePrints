...
namespace BluePrints.ViewModels
{
        ...
        <BASELINE_ITEM, BASELINE_ITEMProgress, Guid, IBluePrintsEntitiesUnitOfWork>, ISupportFiltering<BASELINE_ITEMProgress>
    {
        ...
        public override string UnifiedValueValidation(BASELINE_ITEMProgress entity, string column_name, object newValue, bool isPaste)
        {
            ...
            //don't validate doc type so that users can change it freely without phase restriction, phase will be autogenerated after changing doc type
        ...
        public void AutoPopulate(object button)
        {
            ...
            var phaseFieldName = formatFieldNameForProjectionProperty(BindableBase.GetPropertyName(() => new BASELINE_ITEM().GUID_PHASE));
            ...
            foreach (var entity in SelectedEntities)
            {
                ...
                else if (fieldName == phaseFieldName)
                {
                    //this will trigger autopopulate on OnBeforeProjectionSaveIsContinue
                    entitiesToSave.Add(entity);
                }
