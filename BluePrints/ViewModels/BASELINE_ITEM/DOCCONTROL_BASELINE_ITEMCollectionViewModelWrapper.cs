        ...
        public void SendEmail()
        {
            ...
            foreach (BASELINE internalNumberBaseline in internalNumberBaselines)
            {
                ...
                if (user != null)
                {
                    ...
                    EmailServices.SendEmailFromDocControl(LoginCredentials.CurrentUser.NAME, "Deliverable(s) internal number in project " + internalNumberBaseline.PROJECT.NUMBER + " has been approved!", "Deliverable Internal Numbers Approved for " + internalNumberBaseline.PROJECT.NUMBER, user.NAME + "@primero.com.au");
                }
            }
            ...
            foreach (BASELINE clientNumberBaselines in clientNumberBaselines)
            {
                ...
                if (user != null)
                {
                    ...
                    EmailServices.SendEmailFromDocControl(LoginCredentials.CurrentUser.NAME, "Deliverable(s) client number in project " + clientNumberBaselines.PROJECT.NUMBER + " has been approved!", "Deliverable Client Numbers Approved for " + clientNumberBaselines.PROJECT.NUMBER, user.NAME + "@primero.com.au");
                }
            }
