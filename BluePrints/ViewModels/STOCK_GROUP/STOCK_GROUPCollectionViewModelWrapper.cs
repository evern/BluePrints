...
namespace BluePrints.ViewModels
{
        ...
        <STOCK_GROUP, STOCK_GROUPProjection, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedValueValidation(STOCK_GROUPProjection projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
        #endregion
        ...
        {
            get { return "STOCK_GROUPCollectionViewModelWrapper_v2"; }
        }
