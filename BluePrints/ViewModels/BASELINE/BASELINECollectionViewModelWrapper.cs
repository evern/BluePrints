...
namespace BluePrints.ViewModels
{
        ...
        <BASELINE, BASELINE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string ViewName
        {
            ...
            get { return "BASELINECollectionViewModelWrapper_v1" + view_project_specific_affix; }
        }
        ...
        public void P6BASELINE_ASSIGN()
        {
            ...
            DocumentInfo DocumentInfo = new DocumentInfo(DisplaySelectedEntity.GUID.ToString(), new object[] { DisplaySelectedEntity, BaselineMappingSelectionType.Original, loadPROJECT, false }, viewName, DisplaySelectedEntity.NAME + " - " + DisplaySelectedEntity.P6BASELINE_NAME + " Mapping");
            DocumentManagerService.ShowExistingEntityDocumentWithLogging(DocumentInfo, this);
        }
