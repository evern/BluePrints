...
namespace BluePrints.ViewModels
{
        ...
        <PHASE, PHASE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        /// </summary>
        public bool OnBeforeEntitySaved(PHASE entity)
        {
            return true;
        }
        ...
        public override string UnifiedValueValidation(PHASE projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
