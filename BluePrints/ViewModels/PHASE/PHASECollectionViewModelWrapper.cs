...
{
    public class PHASECollectionViewModelWrapper : CollectionViewModelsWrapper<PHASE, PHASE, Guid, IBluePrintsEntitiesUnitOfWork, CollectionViewModel<PHASE, PHASE, Guid, IBluePrintsEntitiesUnitOfWork>>
    {
        /// <summary>
        /// Creates a new instance of PHASECollectionViewModelWrapper as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static PHASECollectionViewModelWrapper Create(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected PHASECollectionViewModelWrapper(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        }
        ...
        {
            CreateMainViewModel(this.bluePrintsUnitOfWorkFactory, x => x.PHASES);
        ...
        protected override string ViewName
        {
            get
            {
                return "PHASECollectionViewModelWrapper";
            }
        }
        #endregion
    }
