...
namespace BluePrints.ViewModels
{
        ...
        <TENDER_PROFILE, TENDER_PROFILE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedValueValidation(TENDER_PROFILE projection, string field_name, object new_value)
        {
            return string.Empty;
        }
        ...
        {
            get { return "TENDER_PROFILECollectionViewModelWrapper"; }
        }
