...
namespace BluePrints.ViewModels
{
    public class PROJECTForecastSnapshotViewModelWrapper : BluePrintsEntitiesCollectionWrapper<Data.PROJECT, Data.PROJECT, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        protected PROJECTForecastSnapshotViewModelWrapper(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
            ...
            canFilterUninvoicedOnly = LoginCredentials.getPermissionStatus(DataUtils.GetNameOf(() => NavigationResources.Permission_Forecast_FilterUninvoicedOnly)) == LoginCredentials.PermissionStatus.All;
        ...
        bool canFilterUninvoicedOnly;
        bool isShowUninvoicedOnly;
        public bool IsShowUninvoicedOnly
        {
            get
            {
                if (!canFilterUninvoicedOnly)
                    return false;

                return isShowUninvoicedOnly;
            }
            set
            {
                if(!canFilterUninvoicedOnly)
                {
                    MessageBoxService.ShowMessage("You do not have authority to use this function", "Warning", MessageButton.OK);
                    return;
                }
        ...
        private Func<IRepositoryQuery<Data.FORECAST>, IQueryable<Data.FORECAST>> FORECASTProjectionFunc()
        {
            return query => query.Where(x => x.GUID == LoadPROJECT.GUID);
        }
        ...
        {            
            ...
            if (DataDateFORECAST_JOB_HOUR_SNAPSHOTCollection.Count() == 0)
            {
        ...
        private void updateDataPointsTable()
        {
            ...
            DateTime actualsEarliestDate = DataDateFORECAST_JOB_HOUR_SNAPSHOTCollection.Where(x => x.SNAPSHOT_TYPE == ForecastSnapshotValueType.Actual && x.FORECAST_DATE != null).Count() == 0 ? DateTime.Now : DataDateFORECAST_JOB_HOUR_SNAPSHOTCollection.Where(x => x.SNAPSHOT_TYPE == ForecastSnapshotValueType.Actual && x.FORECAST_DATE != null).Min(x => (DateTime)x.FORECAST_DATE);
        ...
        {
            List<FORECAST_JOB_HOUR_SNAPSHOT> snapShots = DataDateFORECAST_JOB_HOUR_SNAPSHOTCollection.Where(x => x.FORECAST_DATE != null).ToList();
        ...
        private void InitializeColumnSource(ObservableCollection<ColumnDescriptor> columns, ObservableCollection<SummaryDescriptor> summaries, List<DateTime> alignedDates, bool isChild)
        {
            ...
            if (!isChild)
            {
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.TenderBudget", ReadOnly = false, Header = "Tender Budget\n(H)", Increment = 1, Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Budget, Mask = "c0", HeaderToolTip = "Budget saved here during Roll Over" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.TenderBudget", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.Budget", ReadOnly = false, Header = "Project Budget\n(A)", Increment = 1, Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Budget, HeaderToolTip = "EAC saved here during Roll Over" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.Budget", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.BudgetVariance", ReadOnly = true, Header = "Rev 0 Variance\n(I)\n(H - A)", Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Budget variance from first EAC" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.ActualCosts", ReadOnly = true, Header = "Actual Costs\n(B)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Costs burned to Date. Materials to Data Date and Time is the Sunday before Data Date" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.ActualCostsPostDataDate", ReadOnly = true, Header = "Actual Costs\nPost DD", Fixed = FixedStyle.Left, Width = 50, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Actual costs post data date" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.ActualCostsPostDataDate", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.ActualCumulativeCostsPreviousDataDate", ReadOnly = true, Header = "Actual Costs\nPrevious DD", Visible = false, Fixed = FixedStyle.Left, Width = 50, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Actual costs up to a month before data date" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.ActualCumulativeCostsPreviousDataDate", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.Outstanding", ReadOnly = true, Header = "Outstanding\n(C)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.POError, Mask = "c0", HeaderToolTip = "Open Commitment, amount left on purchase order (outstanding PO) or amount left on P6 forecasts" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.TotalCommitment", ReadOnly = true, Header = "Total Commitment\n(B + C)", Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Total actuals and PO outstanding" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.Uncommitted", ReadOnly = true, Header = "Uncommitted\n(D)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "(Sum of uncommitted costs - (costs from the forecasting months)) + (P6 Costs with or without PF)" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.PreviousEAC", ReadOnly = isPreviousEACReadOnly, Header = "Prev. EAC\n(F)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Previous estimate at completion" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.PreviousEAC", DisplayFormat = "c0", Type = SummaryItemType.Sum });

                columns.Add(new ColumnDescriptor() { FieldName = "Entity.EstimateAtCompletion", ReadOnly = true, Header = "EAC\n(E)\n(B + C + D)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Estimate at complete, forecasted costs + open commitments + accruals" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.EstimateAtCompletion", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.Variance", ReadOnly = true, Header = "Budget\nVariance\n(A - E)", Fixed = FixedStyle.Left, Width = 70, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Variance to budget" });
                summaries.Add(new SummaryDescriptor() { FieldName = "Entity.Variance", DisplayFormat = "c0", Type = SummaryItemType.Sum });
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.PeriodMovement", Header = "EAC Period Move\n(G)", Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Number, Mask = "c0", HeaderToolTip = "Difference from previous EAC" });
                ...
                columns.Add(new ColumnDescriptor() { FieldName = "Entity.PercentagePeriodMovement", Header = "Percentage Period Move\n(G / F)", Fixed = FixedStyle.Left, Width = 75, Settings = SettingsType.Number, Mask = "p0", HeaderToolTip = "Period Movement / Previous EAC" });
        ...
        public void SaveCurrentMonthEAC()
        {
            ...
            ConcurrentBag<FORECAST_EAC> newFORECAST_EACS = new ConcurrentBag<FORECAST_EAC>();
            ConcurrentBag<FORECAST> newFORECASTS = new ConcurrentBag<FORECAST>();


            List<DataRow> jobRows = new List<DataRow>();
            foreach (DataRow jobRow in DataPointsTable.Rows)
            {
                jobRows.Add(jobRow);
            }

            ConcurrentBag<ForecastJobSnapshot> forecastJobSnapshots = new ConcurrentBag<ForecastJobSnapshot>();
            Parallel.ForEach(jobRows, jobRow =>
            {
                ForecastJobSnapshot entity = (ForecastJobSnapshot)jobRow[columnEntity];
                forecastJobSnapshots.Add(entity);
                string normalizedVariationCode = DataUtils.NormalizeString(entity.VariationCode);
                IEnumerable<FORECAST_EAC> jobFORECAST_EACs = AllFORECAST_EACCollection.Where(x => x.SUBJOB_CODE == entity.SubJobCode && x.DISCIPLINE_CODE == entity.DisciplineCode && x.COMMODITY_CODE == entity.CommodityCode && x.VARIATION_CODE == normalizedVariationCode && x.DELETED == null && x.FORECAST_DATE.Date == FixedDataDateMonthEnd.Date);

                newFORECAST_EACS.Add(findExistingOrAddNewEAC(FixedDataDateMonthEnd, entity, bluePrintsUnitOfWork, entity.EstimateAtCompletion, false, ForecastEACType.EAC, jobFORECAST_EACs, true));
                newFORECAST_EACS.Add(findExistingOrAddNewEAC(FixedDataDateMonthEnd, entity, bluePrintsUnitOfWork, entity.TotalCommitment, false, ForecastEACType.PreviousCommitment, jobFORECAST_EACs, true));

                //this is handled by ForecastDataType.DataDateForecast
                //ForecastDateSnapshot firstForecastMonthDateCost = entity.DateCosts.FirstOrDefault(x => x.QueryDate.Date == firstForecastDate.Date);
                //if (firstForecastMonthDateCost != null)
                //    newFORECAST_EACS.Add(findExistingOrAddNewEAC(FixedDataDateMonthEnd, entity, bluePrintsUnitOfWork, firstForecastMonthDateCost.TotalCosts, false, ForecastEACType.PreviousForecast, jobFORECAST_EACs, true));

                decimal firstForecastDateValue = (decimal)jobRow[firstForecastDate.ToString(BluePrintsResources.ColumnDateFormat)];
                FORECAST findFORECASTS = DataDateFORECASTCollection.FirstOrDefault(x => x.FORECAST_DATE == firstForecastDate && x.SUBJOB_CODE == entity.SubJobCode && x.DISCIPLINE_CODE == entity.DisciplineCode && x.COMMODITY_CODE == entity.CommodityCode && x.VARIATION_CODE == entity.VariationCode);
                ...
                else
                {
                    ...
                    newFORECASTS.Add(findFORECASTS);
                    //bluePrintsUnitOfWork.FORECASTS.Add(findFORECASTS);
                }

                saveCount += 1;
                Common.LoadingScreenManager.SetMessage("Saving: " + saveCount + " of " + DataPointsTable.Rows.Count);
                Common.LoadingScreenManager.Progress();
            });

            //remove all unused entries such at it doesn't tarnish the result with deprecated data
            ConcurrentBag<FORECAST_EAC> forecastEACsToRemove = new ConcurrentBag<FORECAST_EAC>();
            Parallel.ForEach(bluePrintsUnitOfWork.FORECAST_EACS, forecastEAC =>
            {
                if(forecastEAC.FORECAST_DATE.Date == FixedDataDateMonthEnd.Date)
                    if (!forecastJobSnapshots.Any(x => x.SubJobCode == forecastEAC.SubJobCode && x.DisciplineCode == forecastEAC.DisciplineCode && x.CommodityCode == forecastEAC.CommodityCode && DataUtils.NormalizeString(x.VariationCode) == DataUtils.NormalizeString(x.VariationCode)))
                        forecastEACsToRemove.Add(forecastEAC);
            });

            bluePrintsUnitOfWork.FORECAST_EACS.RemoveRange(forecastEACsToRemove);
            bluePrintsUnitOfWork.SaveChanges();
            FORECAST_EACCollectionViewModel.Refresh();
            ...
            bluePrintsUnitOfWork.FORECAST_EACS.AddRange(newFORECAST_EACS.Where(x => x != null));
            bluePrintsUnitOfWork.FORECASTS.AddRange(newFORECASTS.Where(x => x != null));
            bluePrintsUnitOfWork.SaveChanges();
            Common.LoadingScreenManager.CloseLoadingScreen();
        ...
        private DateTime getLastSecondOfDay(DateTime date)
        {
        ...
        public void EditDataDates()
        {
            ...
            if (DateFromToDialogService.ShowDialog(MessageButton.OKCancel, "Pick any date in the month. Dates will auto adjust to last day of the month", "DateFromTo", dateFromToViewModel) == MessageResult.OK)
            {
                DateTime dataDate = dateFromToViewModel.DateFrom;
                DateTime endDate = dateFromToViewModel.DateTo;

                DateTime? dataDateLastDayOfMonth = getLastDayOfMonth(dataDate, false);
                ...
                fixedDataDate = getLastSecondOfDay((DateTime)dataDateLastDayOfMonth);
                fixedEndDate = getLastSecondOfDay((DateTime)endDateLastDayOfMonth);
                SaveDateAndRefresh();
            }
        }
        ...
        private FORECAST_EAC findExistingOrAddNewEAC(DateTime forecastDate, ForecastJobSnapshot entity, IBluePrintsEntitiesUnitOfWork bluePrintsEntitiesUnitOfWork, decimal newPreviousEAC, bool save, ForecastEACType forecastEACType, IEnumerable<FORECAST_EAC> relevantForecastEACs = null, bool deferredForecastAddition = false)
        {
            ...
            FORECAST_EAC forecastEAC;
            if(relevantForecastEACs == null)
            {
                string normalizedVariationCode = DataUtils.NormalizeString(entity.VariationCode);
                IEnumerable<FORECAST_EAC> jobFORECAST_EACs = AllFORECAST_EACCollection.Where(x => x.SUBJOB_CODE == entity.SubJobCode && x.DISCIPLINE_CODE == entity.DisciplineCode && x.COMMODITY_CODE == entity.CommodityCode && x.VARIATION_CODE == normalizedVariationCode && x.DELETED == null && x.FORECAST_DATE == forecastDate && x.TYPE == forecastEACType);
                ...
                forecastEAC = jobFORECAST_EACs.FirstOrDefault();
            }
            else
                forecastEAC = relevantForecastEACs.FirstOrDefault(x => x.TYPE == forecastEACType);

            if (forecastEAC != null)
            {
                forecastEAC.FORECAST_COSTS = newPreviousEAC;
                forecastEAC.TYPE = forecastEACType;
                forecastEAC.UPDATED = DateTime.Now;
                forecastEAC.UPDATEDBY = LoginCredentials.CurrentUserGuid;
                if (save)
                    bluePrintsEntitiesUnitOfWork.SaveChanges();
            }
            else
            {
                forecastEAC = createNewEAC(forecastDate, entity, newPreviousEAC, forecastEACType);
                if (deferredForecastAddition)
                    return forecastEAC;
                else
                    bluePrintsEntitiesUnitOfWork.FORECAST_EACS.Add(forecastEAC);
        ...
        private void findExistingOrAddNewProjectEAC(DateTime forecastDate, decimal newEACRevenue, IBluePrintsEntitiesUnitOfWork bluePrintsEntitiesUnitOfWork, bool save, ForecastEACType forecastEACType)
        {
            ...
            IEnumerable<FORECAST_EAC> jobEACRevenue = AllFORECAST_EACCollection.Where(x => x.GUID_PROJECT == LoadPROJECT.GUID && x.DELETED == null && x.FORECAST_DATE == forecastDate && x.TYPE == forecastEACType);
        ...
        private void findExistingOrAddNewEACHistory(DateTime forecastDate, ForecastSummary entity, IBluePrintsEntitiesUnitOfWork bluePrintsEntitiesUnitOfWork)
        {
            ...
            //forecast date is saved as raw date without 23:59:59 time in order for excel file to retrieve it
            DateTime rawForecastDate = forecastDate.Date;
            forecast_history.EAC_DATE = rawForecastDate;
        ...
        private void setFilter(DataRowView dataRowView, GridColumn gridColumn)
        {
            ...
            if (DateTime.TryParse(gridColumn.ActualColumnChooserHeaderCaption.ToString(), out parseEndDate))
            {
                ...
                parseEndDate = getLastSecondOfDay(parseEndDate);
                ...
                if(IsShowUninvoicedOnly)
                {
                    if (parseEndDate.Date == alignedDataDateCollection.First().Date)
                    {
                        if (entity.CommodityCode != string.Empty)
                            ActualFilterCriteria = CriteriaOperator.Parse("[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode + "' And [LINE_STATUS] <> 'I' And [COMMODITY_CODE] = '" + entity.CommodityCode + "' And [TRANSDATE] <= #" + EndSelectionDate.Year + "-" + EndSelectionDate.Month + "-" + EndSelectionDate.Day + "#");
                        else
                            ActualFilterCriteria = CriteriaOperator.Parse("[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode + "' And [LINE_STATUS] <> 'I' And [TRANSDATE] <= #" + EndSelectionDate.Year + "-" + EndSelectionDate.Month + "-" + EndSelectionDate.Day + "#");
                    }
                    else
                    {
                        if (entity.CommodityCode != string.Empty)
                            ActualFilterCriteria = CriteriaOperator.Parse("[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode + "' And [LINE_STATUS] <> 'I' And [COMMODITY_CODE] = '" + entity.CommodityCode + "' And [TRANSDATE] >= #" + StartSelectionDate.Year + "-" + StartSelectionDate.Month + "-" + StartSelectionDate.Day + "# And [TRANSDATE] <= #" + EndSelectionDate.Year + "-" + EndSelectionDate.Month + "-" + EndSelectionDate.Day + "#");
                        else
                            ActualFilterCriteria = CriteriaOperator.Parse("[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode + "' And [LINE_STATUS] <> 'I' And [TRANSDATE] >= #" + StartSelectionDate.Year + "-" + StartSelectionDate.Month + "-" + StartSelectionDate.Day + "# And [TRANSDATE] <= #" + EndSelectionDate.Year + "-" + EndSelectionDate.Month + "-" + EndSelectionDate.Day + "#");
                    }
                }
                else
                {
            ...
            {
                DateTime dataDate = (DateTime)FixedDataDate;
                bool isActualOnlyDate = gridColumn.FieldName.Contains(BindableBase.GetPropertyName(() => new ForecastJobSnapshot().ActualCostsOnDataDate));
                ForecastJobSnapshot entity = (ForecastJobSnapshot)dataRowView[columnEntity];
                ...
                {
                    if (entity.CommodityCode != string.Empty)
                        criteriaString = "[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode + "' And [COMMODITY_CODE] = '" + entity.CommodityCode + "' And [LINE_STATUS] <> 'I'";
                    else
                ...
                else 
                {
                    if (entity.CommodityCode != string.Empty)
                        ...
                        criteriaString = "[SUB_JOBCODE] = '" + entity.SubJobCode + "' And [DISCIPLINE_CODE] = '" + entity.DisciplineCode + "' And [VARIATION_CODE] = '" + entity.VariationCode;
                }
                ...
                ActualFilterCriteria = CriteriaOperator.Parse(criteriaString);
                IsHidden = false;
                IsPoDetailsVisible = false;
                this.RaisePropertyChanged(x => x.ActualsDetail);
                this.RaisePropertyChanged(x => x.ActualFilterCriteria);
        ...
        public IEnumerable<FORECAST_JOB_HOUR_SNAPSHOT> AllFORECAST_JOB_HOUR_SNAPSHOTCollection
        {
            get
            {
        ...
        public IEnumerable<FORECAST_JOB_HOUR_SNAPSHOT> DataDateFORECAST_JOB_HOUR_SNAPSHOTCollection
        {
            get
            {
                var collection = GetEntities<FORECAST_JOB_HOUR_SNAPSHOT>();
                return collection.Where(x => x.DATA_DATE == FixedDataDate);
            }
        }

        public IEnumerable<FORECAST_JOB_HOUR_SNAPSHOT> PreviousDataDateFORECAST_JOB_HOUR_SNAPSHOTCollection
        {
            get
            {
                var collection = GetEntities<FORECAST_JOB_HOUR_SNAPSHOT>();
                return collection.Where(x => x.DATA_DATE == PreviousDataDate);
            }
        }
        ...
        public IEnumerable<FORECAST> DataDateFORECASTCollection
        {
            get
            {
                return GetEntities<FORECAST>().Where(x => x.FORECAST_TYPE == ForecastDataType.DataDateForecast);
            }
        }
        ...
        //this is handled by datadateforecast
        //public IEnumerable<FORECAST_EAC> FORECAST_EACPreviousForecastCollection
        //{
        //    get
        //    {
        //        return GetEntities<FORECAST_EAC>().Where(x => x.TYPE == ForecastEACType.PreviousForecast);
        //    }
        //}
        ...
        public CollectionViewModel<FORECAST_EAC, FORECAST_EAC, Guid, IBluePrintsEntitiesUnitOfWork> FORECAST_EACCollectionViewModel
        {
            get
            {
                if (MainViewModel == null)
                ...
                return (CollectionViewModel<FORECAST_EAC, FORECAST_EAC, Guid, IBluePrintsEntitiesUnitOfWork>)loaderCollection.GetViewModel<FORECAST_EAC>();
            }
        }
        #endregion
    }
    ...
    public class UniqueForecastJob
    {
        ...
        public List<FORECAST_JOB_HOUR_SNAPSHOT> DataDateActualCollection { get; set; }
