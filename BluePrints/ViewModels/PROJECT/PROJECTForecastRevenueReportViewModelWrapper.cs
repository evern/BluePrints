...
{
    public class PROJECTForecastRevenueReportViewModelWrapper :
        ...
        <FORECAST_EAC, FORECAST_EAC, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public static PROJECTForecastRevenueReportViewModelWrapper Create(
            IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
            return ViewModelSource.Create(() => new PROJECTForecastRevenueReportViewModelWrapper(unitOfWorkFactory));
        }
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected PROJECTForecastRevenueReportViewModelWrapper(
            IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        }
