...
namespace BluePrints.ViewModels
{
        ...
        <RA_GUIDE_SUBPROMPT, RA_GUIDE_SUBPROMPT, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        public override string UnifiedValueValidation(RA_GUIDE_SUBPROMPT projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
        ...
        {
            get { return "RA_GUIDE_SUBPROMPTViewModelWrapper_v2"; }
        }
