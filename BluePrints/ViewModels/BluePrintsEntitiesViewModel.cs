...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Transactions2020ToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Transactions", "TransactionCollectionInstantFeedbackView", new DualEntitiesParameter<PROJECT, object>(null, true), null, "2020 Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
