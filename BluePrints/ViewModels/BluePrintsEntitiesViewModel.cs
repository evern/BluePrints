...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Pipeline), string.Empty, dataCategoryDescription.NavigationId, "Pipeline", "PIPELINECollectionView", null, null, null, false, false, @"Business Objects\BOSaleItem_16x16.png"), isSample);
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(construct_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConstructionVariation), projectSpecificKey, design_category_description.NavigationId, childTitlePrefix + "Variations", "VARIATION_CONSTRUCTIONCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Variations", false, false, @"Scheduling\ShowWorkTimeOnly_16x16.png"), isSecurityModule);
            ...
            moduleAdder(projectModuleDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Pipeline), projectSpecificKey, projectModuleDescription.NavigationId, childTitlePrefix + "Monthly HSE Report", "HSECollectionView", new EntitiesParameter<PROJECT>(entity), null, "Monthly HSE Report", false, false, @"Gauges\GaugeStyleLinearHorizontal_16x16.png"), isSecurityModule);
