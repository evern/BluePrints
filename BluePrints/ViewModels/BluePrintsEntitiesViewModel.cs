...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(registerCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Register_Clarification), projectSpecificKey, registerCategoryDescription.NavigationId, childTitlePrefix + "Clarification Register", "REGISTER_CLARIFICATIONCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Clarification Register", false, false, @"Miscellaneous\Comment_16x16.png"), isSecurityModule);
