...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Perth Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.Perth), null, "All Perth Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Montreal Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.Montreal), null, "All Montreal Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All USA Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.Montreal), null, "All USA Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Transactions2020ToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Perth Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Perth), null, "2020 Perth Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Transactions2020ToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Montreal Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Montreal), null, "2020 Montreal Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
