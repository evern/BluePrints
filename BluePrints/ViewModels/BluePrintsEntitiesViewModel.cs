...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsPerthYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Perth Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.Perth), null, "All Perth Transactions", false, false, @"/Common/Images/Australia-Flag.ico"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsMontrealYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Montreal Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.Montreal), null, "All Montreal Transactions", false, false, @"/Common/Images/Canada-Flag.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsUSAYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All USA Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, false, DatabaseLocale.USA), null, "All USA Transactions", false, false, @"/Common/Images/USA-Flag.ico"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsPerth2020ToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Perth Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Perth), null, "2020 Perth Transactions", false, false, @"/Common/Images/Australia-Flag.ico"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsMontreal2020ToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Montreal Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Montreal), null, "2020 Montreal Transactions", false, false, @"/Common/Images/Canada-Flag.png"), isSample);
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(projectModuleDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Subjob), projectSpecificKey, projectModuleDescription.NavigationId, childTitlePrefix + "Sub Jobs", "SUBJOBCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Sub Jobs", false, false, @"Programming\ProjectFile_16x16.png"), isSecurityModule);
            ...
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_JobsHistory), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Jobs History", "EXO_JobHistoryCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Jobs History", false, false, @"Find\FindCustomers_16x16.png"), isSecurityModule);
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_SellPrices), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Sell Prices", "EXO_PricesCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Sell Prices", false, false, @"XAF\BO_Price.png"), isSecurityModule);
            ...
            moduleAdder(forecast_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_ReadOnly), projectSpecificKey, forecast_category_description.NavigationId, childTitlePrefix + "Forecast", "PROJECTForecastSnapshotView", new EntitiesParameter<PROJECT>(entity), null, "Forecast (Read Only)", false, false, @"Function Library\Statistical_16x16.png"), isSecurityModule);
            ...
            moduleAdder(projectModuleDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DisciplineDescription), projectSpecificKey, projectModuleDescription.NavigationId, childTitlePrefix + "Packages", "DISCIPLINE_DESCCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Packages", false, false, @"Support\PackageProduct_16x16.png"), isSecurityModule);
            ...
            : base(id, projectSpecificKey, parentId, title, documentType, documentParameter, image, navigationTitle, treeViewIsExpanded, showInCollapseMode, preferredDocumentType)
        {
            ...
            if(imagePath != string.Empty)
            {
                if (!imagePath.ToUpper().Contains("COMMON"))
                    Image = new BitmapImage(new Uri("pack://application:,,,/DevExpress.Images.v21.1;component/Images/" + imagePath));
                else
            ...
            {
                if (!CanNavigate)
                    Image = new BitmapImage(new Uri("pack://application:,,,/DevExpress.Images.v21.1;component/Images/Data/ManageDataSource_16x16.png"));
                    //new Uri(@"/Common/Images/PRIMERO.jpg", UriKind.Relative));
                else
                    Image = new BitmapImage(new Uri("pack://application:,,,/DevExpress.Images.v21.1;component/Images/Actions/Open_16x16.png"));
            }
        }
