        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity)
        {
            ...
            if (LoginCredentials.hasPermission(PermissionResources.ManageForecast))
            {
                ...
                forecast_category_description.ChildModules.Add(new BluePrintsEntitiesModuleDescription("View_IndirectForecast" + keyString, projectKey, childTitlePrefix + "Indirects Forecast", "PROJECTIndirectForecastView", new DualEntitiesParameter<PROJECT, Action<object>>(entity, NavigateCoreCommand), null, "Indirects Forecast", false, false, @"Function Library\Information_16x16.png"));
