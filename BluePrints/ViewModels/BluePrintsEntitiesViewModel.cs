...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity)
        {
            ...
            {
                construct_category_description.ChildModules.Add(new BluePrintsEntitiesModuleDescription("View_LiveProjectDirectBudgets" + keyString, projectKey, childTitlePrefix + "Direct Jobs", "BUDGET_ITEMCollectionView", new TripleEntitiesParameter<PROJECT, IAmBaseline, object>(entity, null, new KeyValuePair<DeliverablesViewType, EstimateViewMode>(DeliverablesViewType.Direct, EstimateViewMode.Budget)), null, "Direct Jobs", false, false, @"Business Objects\BOEmployee_16x16.png"));
            ...
            if (LoginCredentials.hasPermission(PermissionResources.ManageSubjob))
            {
                construct_category_description.ChildModules.Add(new BluePrintsEntitiesModuleDescription("View_ProjectConstructionExoJobSetup" + keyString, projectKey, childTitlePrefix + "Construction Jobs", "EXO_ConstructionSubjobCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Job Permissions", false, false, @"Business Objects\BOUser_16x16.png"));
...
namespace BluePrints.Common.ViewModel
{
    public partial class BluePrintsEntitiesModuleDescription : ModuleDescription<BluePrintsEntitiesModuleDescription>
    {
            ...
            : base(id, parentId, title, documentType, documentParameter, image, navigationTitle, treeViewIsExpanded, showInCollapseMode)
        {
            ...
            {
                if (!CanNavigate)
                    Image = new BitmapImage(new Uri("pack://application:,,,/DevExpress.Images.v18.2;component/Images/Data/ManageDataSource_16x16.png"));
                    //new Uri(@"/Common/Images/PRIMERO.jpg", UriKind.Relative));
                else
                    Image = new BitmapImage(new Uri("pack://application:,,,/DevExpress.Images.v18.2;component/Images/Actions/Open_16x16.png"));
            }
        }
