...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Transactions", "TransactionCollectionInstantFeedbackView", new DualEntitiesParameter<PROJECT, object>(null, false), null, "All Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "2020 Transactions", "TransactionCollectionInstantFeedbackView", new DualEntitiesParameter<PROJECT, object>(null, true), null, "2020 Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_Transactions), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Transactions", null, new DualEntitiesParameter<PROJECT, object>(entity, false), null, "Transactions", false, false, @"Function Library\Compatibility_16x16.png", null, null, false, () => BluePrintsDataUtils.GetPreferredDocumentTypeName(DataUtils.GetNameOf(() => UserPreferences.EXO_PreloadTransactions))), isSecurityModule);
