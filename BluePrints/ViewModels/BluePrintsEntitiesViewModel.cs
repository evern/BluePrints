...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            BluePrintsEntitiesModuleDescription rateCategoryDescription = new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Category_Project_Rate), string.Empty, projectModuleDescription.NavigationId, "Rates", null, null, null, null, false, false, @"Spreadsheet\FunctionsFinancial_16x16.png");
            ...
            moduleAdder(projectModuleDescription, rateCategoryDescription, isSecurityModule, true);
            ...
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_Jobs), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Jobs", "EXO_SubJobCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Jobs", false, false, @"Function Library\MoreFunctions_16x16.png"), isSecurityModule);
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_JobPermission), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Master Job Permissions", "EXO_JobPermissionCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Master Job Permissions", false, false, @"Business Objects\BOUser_16x16.png"), isSecurityModule);
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_AllPO), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Purchase Orders", "EXO_POCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Purchase Orders", false, false, @"Business Objects\BOProductGroup_16x16.png"), isSecurityModule);

            moduleAdder(forecast_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_PO), projectSpecificKey, forecast_category_description.NavigationId, childTitlePrefix + "PO Forecast", "PROJECTPOForecastView", new EntitiesParameter<PROJECT>(entity), null, "PO Forecast", false, false, @"Business Objects\BOOrderItem_16x16.png"), isSecurityModule);
            ...
            moduleAdder(projectModuleDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Holidays), projectSpecificKey, projectModuleDescription.NavigationId, childTitlePrefix + "Holidays", "HOLIDAYCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Holidays", false, false, @"Scheduling\Calendar_16x16.png"), isSecurityModule);
            ...
            moduleRemover(projectModuleDescription, rateCategoryDescription, isSecurityModule);
        }
