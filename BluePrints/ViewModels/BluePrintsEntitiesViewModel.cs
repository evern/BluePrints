...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_AllPO), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "View PO's", "PROJECTPOCollectionView", new EntitiesParameter<PROJECT>(entity), null, "View PO's", false, false, @"Business Objects\BOProductGroup_16x16.png"), isSecurityModule);
