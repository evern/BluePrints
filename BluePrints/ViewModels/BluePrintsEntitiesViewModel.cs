...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            if(entity.CONTRACTTYPE == ContractType.Rates)
                moduleAdder(forecast_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_Rate), projectSpecificKey, forecast_category_description.NavigationId, childTitlePrefix + "Rate Forecast", "PROJECTRateForecastView", new EntitiesParameter<PROJECT>(entity), null, "Rate Forecast", false, false, @"Spreadsheet\FormatCells_16x16.png"), isSecurityModule);
            else
            {
