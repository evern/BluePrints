...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsPerth2021ToDate), string.Empty, exoDataCategoryDescription.NavigationId, "2021 Perth Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Perth), null, "2021 Perth Transactions", false, false, @"/Common/Images/Australia-Flag.ico"), isSample);
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsMontreal2021ToDate), string.Empty, exoDataCategoryDescription.NavigationId, "2021 Montreal Transactions", "TransactionCollectionInstantFeedbackView", new TripleEntitiesParameter<PROJECT, object, object>(null, true, DatabaseLocale.Montreal), null, "2021 Montreal Transactions", false, false, @"/Common/Images/Canada-Flag.png"), isSample);
