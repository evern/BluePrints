...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsPerthYearToDate), string.Empty, exoDataCategoryDescription.NavigationId, "All Perth Transactions", "TransactionCollectionRegionalInstantFeedbackView", new DualEntitiesParameter<object, object>(DatabaseLocale.Perth, false), null, "All Perth Transactions", false, false, @"/Common/Images/Australia-Flag.ico"), isSample);
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsMontrealYearToDate), string.Empty, exoDataCategoryDescription.NavigationId, "All Montreal Transactions", "TransactionCollectionRegionalInstantFeedbackView", new DualEntitiesParameter<object, object>(DatabaseLocale.Montreal, false), null, "All Montreal Transactions", false, false, @"/Common/Images/Canada-Flag.png"), isSample);
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsUSAYearToDate), string.Empty, exoDataCategoryDescription.NavigationId, "All USA Transactions", "TransactionCollectionInstantFeedbackView", new DualEntitiesParameter<object, object>(DatabaseLocale.USA, false), null, "All USA Transactions", false, false, @"/Common/Images/USA-Flag.ico"), isSample);
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsPerth2021ToDate), string.Empty, exoDataCategoryDescription.NavigationId, "2021 Perth Transactions", "TransactionCollectionRegionalInstantFeedbackView", new DualEntitiesParameter<object, object>(DatabaseLocale.Perth, true), null, "2021 Perth Transactions", false, false, @"/Common/Images/Australia-Flag.ico"), isSample);
            moduleAdder(exoDataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsMontreal2021ToDate), string.Empty, exoDataCategoryDescription.NavigationId, "2021 Montreal Transactions", "TransactionCollectionRegionalInstantFeedbackView", new DualEntitiesParameter<object, object>(DatabaseLocale.Montreal, true), null, "2021 Montreal Transactions", false, false, @"/Common/Images/Canada-Flag.png"), isSample);
        ...
        private void populateProjectTree(PROJECT entity, BluePrintsEntitiesModuleDescription projectModuleDescription, bool isSecurityModule)
        {
            ...
            BluePrintsEntitiesModuleDescription forecast_history_category_description = new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Category_Project_Forecast_History), projectSpecificKey, forecast_category_description.NavigationId, "History", null, null, null, null, false, false, @"Reports\Report_16x16.png");
            ...
            moduleAdder(exo_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_TransactionsApproval), projectSpecificKey, exo_category_description.NavigationId, childTitlePrefix + "Transaction Approvals", "TransactionApprovalView", new EntitiesParameter<PROJECT>(entity), null, "Transaction Approvals", false, false, @"Actions\Apply_16x16.png", null, null, false, null, "Approve transaction changes"), isSecurityModule);
            ...
            moduleAdder(forecast_category_description, forecast_history_category_description, isSecurityModule, true);
            moduleAdder(forecast_history_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_Indirect_History), projectSpecificKey, forecast_history_category_description.NavigationId, childTitlePrefix + "Indirects Forecast History", "PROJECTIndirectForecastHistoryView", new EntitiesParameter<PROJECT>(entity), null, "Indirects Forecast History", false, false, @"Function Library\Information_16x16.png"), isSecurityModule);
            moduleAdder(forecast_history_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_AllEAC), projectSpecificKey, forecast_history_category_description.NavigationId, childTitlePrefix + "View EAC's", "PROJECTForecastEACReportView", new EntitiesParameter<PROJECT>(entity), null, "View EAC's", false, false, @"Scheduling\FullWeekView_16x16.png"), isSecurityModule);
            ...
            moduleAdder(registerCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Register_Risk), projectSpecificKey, registerCategoryDescription.NavigationId, childTitlePrefix + "Design Risk & Hazard Register", "REGISTER_RISKCollectionView", new EntitiesParameter<PROJECT>(entity), null, "Design Risk & Hazard Register", false, false, @"Support\BreakingChange_16x16.png"), isSecurityModule);
        ...
        private void permissionAdder(string securityKey, string parentNavigationId)
        {
            ...
            else if (securityKey == DataUtils.GetNameOf(() => NavigationResources.Menu_Project_EXO_Transactions))
            {
                ...
                Modules.Add(new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Permission_EXO_Transactions_RequiresApproval), securityKey, parentNavigationId, NavigationResources.Permission_EXO_Transactions_RequiresApproval, NavigationResources.Permission_EXO_Transactions_RequiresApproval));
            }
