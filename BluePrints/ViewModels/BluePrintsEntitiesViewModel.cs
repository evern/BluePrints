...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(rateCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DesignDirectChargeRate), projectSpecificKey, rateCategoryDescription.NavigationId, childTitlePrefix + "Charge Rates [Direct]", "RATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Design, ChargeType.Chargeable), null, "Charge Rates [Direct]", false, false, @"Business Objects\BOPerson_16x16.png"), isSecurityModule);
            moduleAdder(rateCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DesignIndirectChargeRate), projectSpecificKey, rateCategoryDescription.NavigationId, childTitlePrefix + "Charge Rates [Indirect]", "RATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Indirect, ChargeType.Chargeable), null, "Charge Rates [Indirect]", false, false, @"Business Objects\BODetails_16x16.png"), isSecurityModule);
            
            moduleAdder(rateCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DesignDirectCostRate), projectSpecificKey, rateCategoryDescription.NavigationId, childTitlePrefix + "Design Cost Rates [Direct]", "CostRATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Design, ChargeType.Chargeable), null, "Cost Rates [Direct]", false, false, @"Business Objects\BOPerson_16x16.png"), isSecurityModule);
            moduleAdder(rateCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DesignIndirectCostRate), projectSpecificKey, rateCategoryDescription.NavigationId, childTitlePrefix + "Design Cost Rates [Indirect]", "CostRATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Indirect, ChargeType.Chargeable), null, "Cost Rates [Indirect]", false, false, @"Business Objects\BODetails_16x16.png"), isSecurityModule);

            moduleAdder(construct_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConstructionDirectChargeRate), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Construction Charge Rates [Direct]", "RATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Construct, ChargeType.Chargeable), null, "Charge Rates [Direct]", false, false, @"Business Objects\BOPerson_16x16.png"), isSecurityModule);
            moduleAdder(construct_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConstructionDirectCostRate), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Construction Cost Rates [Direct]", "CostRATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Construct, ChargeType.Chargeable), null, "Cost Rates [Direct]", false, false, @"Business Objects\BOEmployee_16x16.png"), isSecurityModule);
