...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(construct_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConcreteConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Mechanical Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Concrete), null, "Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
