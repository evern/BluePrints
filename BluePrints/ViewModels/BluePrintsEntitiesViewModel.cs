...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(designRateCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_DesignIndirectChargeRate), projectSpecificKey, designRateCategoryDescription.NavigationId, childTitlePrefix + "Charge Rates [Indirect]", "RATECollectionView", new TripleEntitiesParameter<PROJECT, object, object>(entity, PhaseType.Indirect, ChargeType.Chargeable), null, "Charge Rates [Indirect]", false, false, @"Business Objects\BODetails_16x16.png"), isSecurityModule);
