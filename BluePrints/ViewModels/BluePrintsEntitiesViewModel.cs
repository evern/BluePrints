...
namespace BluePrints.ViewModels
{
        ...
        DocumentsViewModel<BluePrintsEntitiesModuleDescription, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        private RangeObservableCollection<BluePrintsEntitiesModuleDescription> CreateDataModules(bool isSample)
        {
            ...
            moduleAdder(dataCategoryDescription, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_TransactionsYearToDate), string.Empty, dataCategoryDescription.NavigationId, "All Transactions", "TransactionCollectionInstantFeedbackView", new EntitiesParameter<PROJECT>(null), null, "All Transactions", false, false, @"Function Library\Compatibility_16x16.png"), isSample);
        ...
        private void CreateProjectTree(PROJECT entity, bool isSecurityModule)
        {
            ...
            moduleAdder(construct_progress_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConcreteConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Concrete Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Concrete), null, "Concrete Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
            moduleAdder(construct_progress_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ElectricalConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Electrical Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Electrical), null, "Electrical Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
            moduleAdder(construct_progress_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_MechanicalConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Mechanical Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Mechanical), null, "Mechanical Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
            moduleAdder(construct_progress_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_PipingConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Piping Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Piping), null, "Piping Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
            moduleAdder(construct_progress_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_StructuralConstructProgress), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Structural Progress", "SiteDirectProgressCollectionView", new TripleEntitiesParameter<PROJECT, PROGRESS, object>(entity, null, ScoreCardDiscipline.Structural), null, "Structural Progress", false, false, @"Chart\Bar2_16x16.png"), isSecurityModule);
            ...
            moduleAdder(forecast_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_Forecast_Flat_PO), projectSpecificKey, forecast_category_description.NavigationId, childTitlePrefix + "EH PO Forecast", "PROJECTFlatPOForecastView", new EntitiesParameter<PROJECT>(entity), null, "EH PO Forecast", false, false, @"Business Objects\BOOrderItem_16x16.png"), isSecurityModule);
            ...
            moduleAdder(construct_category_description, new BluePrintsEntitiesModuleDescription(DataUtils.GetNameOf(() => NavigationResources.Menu_Project_ConstructionStage), projectSpecificKey, construct_category_description.NavigationId, childTitlePrefix + "Stages", "CONSTRUCTION_STAGECollectionView", new EntitiesParameter<PROJECT>(entity), null, "Stages", false, false, @"XAF\Action_Totals_Column.png"), isSecurityModule);
