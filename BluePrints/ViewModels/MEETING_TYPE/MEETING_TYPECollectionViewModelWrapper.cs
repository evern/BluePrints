...
namespace BluePrints.ViewModels
{
        ...
        <MEETING_TYPE, MEETING_TYPE, Guid, IBluePrintsEntitiesUnitOfWork>
    {
        ...
        {
            get { return "MEETING_TYPECollectionViewModelWrapper_v2"; }
        }
        #endregion
        ...
        public override string UnifiedValueValidation(MEETING_TYPE projection, string field_name, object new_value, bool isPaste)
        {
            return string.Empty;
        }
        #endregion
