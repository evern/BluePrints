...
{
    public class PROGRESSCollectionViewModelWrapper : CollectionViewModelsWrapper<PROGRESS, PROGRESS, Guid, IBluePrintsEntitiesUnitOfWork, CollectionViewModel<PROGRESS, PROGRESS, Guid, IBluePrintsEntitiesUnitOfWork>>, ISupportCustomDocumentTypeNameAndParameter
    {
        /// <summary>
        /// Creates a new instance of PROGRESSCollectionViewModelWrapper as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static PROGRESSCollectionViewModelWrapper Create(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected PROGRESSCollectionViewModelWrapper(IUnitOfWorkFactory<IBluePrintsEntitiesUnitOfWork> unitOfWorkFactory = null)
        {
        }
        ...
        {
            CreateMainViewModel(this.bluePrintsUnitOfWorkFactory, x => x.PROGRESSES);
        ...
        protected override string ViewName
        {
            get
            {
                return "PROGRESSCollectionViewModelWrapper";
            }
        }
        #endregion
