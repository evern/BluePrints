...
namespace BluePrints.Common.ViewModel.Misc
{
    public static class ForecastHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ForecastJobData> CreateDisciplineProjections(IEnumerable<ExoSubJobProjection> unifiedJobList, IEnumerable<ExoTimeAuthorisation> queryJobLines, IEnumerable<DashboardFlatStructure> projectDashboards, IEnumerable<DateTime> dates)
        {
        ...
        private static void populateProjection(ForecastJobData jobForecastSummary, IEnumerable<DashboardFlatStructure> relevantDashboards, IEnumerable<DateTime> dates)
        {
            ...
            if (relevantDashboards != null && relevantDashboards.Count() > 0)
            {
                ...
                //sum outstanding commitments
                //ToDo: get po forecast
