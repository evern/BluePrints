            ...
            Guid? project_guid = null, bool buildStats = false, IEnumerable<USER> USERCollection = null, IEnumerable<BASELINE_ITEM_WORK> BASELINE_ITEM_WORKCollection = null, IEnumerable<STOCK_CODE> STOCKCODECollection = null, DateTime? fixedStartDate = null, DateTime? fixedDataDate = null, bool showLoadingScreen = false, bool forceRetrieveRemainingDataPoints = false)
        {
            ...
            foreach (var current_project in project_single_or_active_selection)
            {
                ...
                if (live_baseline != null && live_baseline_progresses != null)
                {
                    ...
                    live_baseline_items.AsQueryable(), current_project, live_baseline_progress, project_rates, live_baseline_progresses, approved_project_variations, false, null, DeliverableInternalNumberMode.Default, true, null, USERCollection, BASELINE_ITEM_WORKCollection, null, null, null, null, null, null, null, showLoadingScreen).ToArray().AsEnumerable();
