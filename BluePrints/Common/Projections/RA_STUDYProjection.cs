...
namespace BluePrints.Common.Projections
{
    public class RA_STUDYProjection : BluePrintsProjectionBase<RA_STUDY>
    {
        ...
        public RA_STUDYProjection(RA_STUDY study, IEnumerable<RA_STUDY_DATA> study_datas, IEnumerable<RA_STUDY_DRAWING> study_drawings, IEnumerable<RA_STUDY_NODE> study_nodes, IEnumerable<RA_STUDY_TEAM> study_teams)
        {
            Entity = study;
