...
namespace BluePrints.Views
{
    public partial class USERDashboardView : UserControl
    {
        ...
        {
            InitializeComponent();
            ((USERDashboardViewModelWrapper)DataContext).ChangeViewMemberFieldNames =
                ChangeViewMemberFieldNames;
            ((USERDashboardViewModelWrapper)DataContext).Redraw = Redraw;
        }
        ...
        public void ChangeViewMemberFieldNames(DashboardViewType DashboardViewType)
        {
            ...
            colCumulativePlannedPercentage.FieldName = colCumulativePlannedPercentage.FieldName.Replace(fieldNameReplaceFrom, fieldNameReplaceTo);
            ...
            colPeriodPlannedPercentage.FieldName = colPeriodPlannedPercentage.FieldName.Replace(fieldNameReplaceFrom, fieldNameReplaceTo);
