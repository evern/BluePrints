...
namespace BluePrints.Views
{
    public partial class PROJECTView : UserControl
    {
        ...
        {
            InitializeComponent();
            ((PROJECTViewModelWrapper)this.DataContext).ChangeViewMemberFieldNames = this.ChangeViewMemberFieldNames;
            ((PROJECTViewModelWrapper)this.DataContext).Redraw = this.Redraw;
        }
