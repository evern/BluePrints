...
namespace BluePrints.BluePrintsEntitiesDataModel
{
    ...
    public class BluePrintsEntitiesUnitOfWork : DbUnitOfWork<BluePrintsEntities>, IBluePrintsEntitiesUnitOfWork
    {
        ...
        {
            get { return GetRepository(x => x.Set<FORECAST_AUDIT>(), (FORECAST_AUDIT x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository(x => x.Set<FORECAST_JOB_AUDIT>(), (FORECAST_JOB_AUDIT x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository(x => x.Set<FORECAST_JOB_HOUR_AUDIT>(), (FORECAST_JOB_HOUR_AUDIT x) => x.GUID); }
        }
