...
namespace BluePrints.BluePrintsEntitiesDataModel
{
    ...
    public class BluePrintsEntitiesDesignTimeUnitOfWork : DesignTimeUnitOfWork, IBluePrintsEntitiesUnitOfWork
    {
        ...
        {
            get { return GetRepository((FORECAST_HISTORY x) => x.GUID); }
        }

        IRepository<FORECAST_AUDIT, Guid> IBluePrintsEntitiesUnitOfWork.FORECAST_AUDITS
        {
            get { return GetRepository((FORECAST_AUDIT x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((FORECAST_JOB_HOUR x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((JOBCOST_LINES_AUDIT x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((PROGRESS_ETC x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((REGISTER_TQ x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((USER_PINNED_PROJECT x) => x.GUID); }
        }

        IRepository<USER_PREFERENCE, Guid> IBluePrintsEntitiesUnitOfWork.USER_PREFERENCES
        {
            get { return GetRepository((USER_PREFERENCE x) => x.GUID); }
        }
        ...
        {
            get { return GetRepository((TRANSACTION_AUDIT x) => x.GUID); }
        }
    }
}