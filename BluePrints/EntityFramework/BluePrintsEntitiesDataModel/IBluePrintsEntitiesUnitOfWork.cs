...
namespace BluePrints.BluePrintsEntitiesDataModel
{
    ...
    public interface IBluePrintsEntitiesUnitOfWork : IUnitOfWork
    {
        ...
        /// <summary>
        /// The FORECAST_HISTORIES entities repository.
        /// </summary>
        IRepository<FORECAST_HISTORY, Guid> FORECAST_HISTORIES { get; }

        /// <summary>
        /// The FORECAST_AUDIT entities repository.
        /// </summary>
        IRepository<FORECAST_AUDIT, Guid> FORECAST_AUDITS { get; }
        ...
        /// <summary>
        /// The FORECAST_JOB_AUDIT entities repository.
        /// </summary>
        IRepository<FORECAST_JOB_AUDIT, Guid> FORECAST_JOB_AUDITS { get; }
        ...
        /// <summary>
        /// The FORECAST_JOB_HOUR_AUDIT entities repository.
        /// </summary>
        IRepository<FORECAST_JOB_HOUR_AUDIT, Guid> FORECAST_JOB_HOUR_AUDITS { get; }
